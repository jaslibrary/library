...
import { fetchEnhancedBookMetadata, cleanGoogleBooksGenre } from '../utils/bookMetadata';
        ...
        try {
            ...
            if (data.totalItems > 0) {
                ...
                if (volume.categories && volume.categories.length > 0) {
                    foundGenre = cleanGoogleBooksGenre(volume.categories[0]);
                }
    ...
    const handleManualSubmit = async () => {
        ...
        try {
            ...
            if (data.totalItems > 0) {
                ...
                // Use cleaner:
                foundGenre = cleanGoogleBooksGenre(vol.categories[0]);
            }
        }
        } catch (e) {
